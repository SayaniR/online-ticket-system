...
CREATE TABLE `csr` (
  `csrId` int NOT NULL,
  `csrPassword` varchar(20) DEFAULT NULL,
  `csrName` varchar(20) DEFAULT NULL,
  `csrEmail` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`csrId`)
...
INSERT INTO `csr` VALUES (1,'1234','prasun','prasun@123');
...
-- Dump completed on 2022-01-27 15:22:55
