            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Generate new Ticket</h1>
                        <!--                        <ol class="breadcrumb mb-4">
                                                    <li class="breadcrumb-item active">here are all the issues</li>
                                                </ol>-->
                        <s:form action="registerissue" method="post">
                            <s:textfield label="Issue Id" name="issueId" />
                            <s:textfield label="Issue Type" name="issueType" />
                            <s:textarea label="Issue Description" name="issueDescription" />
                            <s:textarea label="Equipment Type" name="equipmentType" />
                            ...
                            <s:date name="dateCaused" format="MM/dd/yyyy" />
                            <s:date name="tentativeDates" format="MM/dd/yyyy" />
