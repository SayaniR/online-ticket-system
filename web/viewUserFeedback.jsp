                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">here are your reviews</li>
                        </ol>
                        <s:form action="showuserfeedback" method="post">
                            <s:textfield label="Issue Id" name="issueId" />
                            <s:submit cssClass="button-register" value="View Feedback" />
...
<!--                                        <th>Issue Id &nbsp; &nbsp;</th>-->
                                ...
                                <s:iterator value="ufList">                                                       
                                    <tr>
<!--                                        <td><s:property value="issueId" />&nbsp; &nbsp;</td>-->
                                        <td><s:property value="userName" />&nbsp; &nbsp;</td>
                                        <td><s:property value="userFeedback" />&nbsp; &nbsp;</td>
                                    </tr>
