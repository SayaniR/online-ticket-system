            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">View your solution</h1>
                        <ol class="breadcrumb mb-4">
                            <!--<li class="breadcrumb-item active">here are your tickets</li>-->
                        </ol>
                        <s:form action="showfeedback" method="post">
                            <s:textfield label="Issue Id" name="issueId" />
                            <s:submit cssClass="button-register" value="View Solution" />
