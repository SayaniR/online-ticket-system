            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Add new Csr</h1>
                        <!-- <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">here are all the issues</li>
                        </ol>-->
                        <s:form action="registercsr" method="post">
                            <s:textfield label="Csr Id" name="csrId" />
                            <s:textfield label="Csr Name" name="csrName" />
                            <s:textarea label="Csr Email" name="csrEmail" />
                            <s:textarea label="Csr Password" name="csrPassword" />

                            <s:submit cssClass="button-register" value="Add Csr" />
                        </s:form>
                        <s:if test="ctr>0">
